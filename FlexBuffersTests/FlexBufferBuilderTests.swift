...
class FlexBufferBuilderTests: XCTestCase {
    ...
    func testBuildingVector() {
        ...
        XCTAssertEqual((v?.root?[9]?.asVector?.makeIterator().flatMap{$0.asString})!, ["a", "b"])
        XCTAssertEqual((v?.root?[10]?.asVector?.makeIterator().flatMap{$0.asString})!, ["a!", "b!"])
        XCTAssertEqual((v?.root?[11]?.asVector?.makeIterator().flatMap{$0.asInt})!, [1, 2, 3])
        XCTAssertEqual((v?.root?[12]?.asVector?.makeIterator().flatMap{$0.asUInt})!, [1, 2, 3])
        XCTAssertEqual((v?.root?[13]?.asVector?.makeIterator().flatMap{$0.asBool})!, [true, false])
        XCTAssertEqual((v?.root?[14]?.asVector?.makeIterator().flatMap{$0.asDouble})!, [1.0, 0.2, 0.5])
        XCTAssertEqual((v?.root?[15]?.asVector?.makeIterator().flatMap{$0.asDouble})!, [1.0, 2.3])
        XCTAssertEqual((v?.root?[16]?.asVector?.makeIterator().flatMap{$0.asDouble})!, [1.0, 2.3, 4.5])
        XCTAssertEqual((v?.root?[17]?.asVector?.makeIterator().flatMap{$0.asDouble})!, [1.0, 2.3, 4.5, 5.6])
        XCTAssertEqual((v?.root?[18]?.asVector?.makeIterator().flatMap{$0.asInt})!, [1, 2])
        XCTAssertEqual((v?.root?[19]?.asVector?.makeIterator().flatMap{$0.asInt})!, [1, 2, 4])
        XCTAssertEqual((v?.root?[20]?.asVector?.makeIterator().flatMap{$0.asInt})!, [1, 2, 4, 7])
        XCTAssertEqual((v?.root?[21]?.asVector?.makeIterator().flatMap{$0.asUInt})!, [1, 2])
        XCTAssertEqual((v?.root?[22]?.asVector?.makeIterator().flatMap{$0.asUInt})!, [1, 2, 4])
        XCTAssertEqual((v?.root?[23]?.asVector?.makeIterator().flatMap{$0.asUInt})!, [1, 2, 4, 7])
        XCTAssertEqual(String(data: (v?.root?[24]?.asData)!, encoding: .utf8), "hello")
        XCTAssertEqual((v?.root?[25]?.asVector?.makeIterator().flatMap{$0.asInt})!, [1, 3])
        XCTAssertEqual((v?.root?[26]?.asMap?.toDict(converter: {$0.asInt}))!, ["a": 12, "b": 4])
        XCTAssertEqual((v?.root?[27]?.asVector?.makeIterator().flatMap{$0.asInt64})!, [Int64.min, Int64.max])
        XCTAssertEqual((v?.root?[28]?.asVector?.makeIterator().flatMap{$0.asUInt64})!, [UInt64.min, UInt64.max])
    ...
    func testBuildingMap() {
        ...
        XCTAssertEqual((m?.root?["ae"]?.asVector?.makeIterator().flatMap{$0.asInt})!, [1, 2])
        XCTAssertEqual((m?.root?["af"]?.asVector?.makeIterator().flatMap{$0.asInt})!, [2, 3])
        XCTAssertEqual((m?.root?["ag"]?.asVector?.makeIterator().flatMap{$0.asInt})!, [1, 2, 3])
        XCTAssertEqual((m?.root?["ah"]?.asVector?.makeIterator().flatMap{$0.asInt})!, [2, 3, 4])
        XCTAssertEqual((m?.root?["ai"]?.asVector?.makeIterator().flatMap{$0.asInt})!, [1, 2, 3, 4])
        XCTAssertEqual((m?.root?["aj"]?.asVector?.makeIterator().flatMap{$0.asInt})!, [2, 3, 4, 5])
        XCTAssertEqual((m?.root?["ak"]?.asVector?.makeIterator().flatMap{$0.asUInt})!, [1, 2])
        XCTAssertEqual((m?.root?["al"]?.asVector?.makeIterator().flatMap{$0.asUInt})!, [2, 3])
        XCTAssertEqual((m?.root?["am"]?.asVector?.makeIterator().flatMap{$0.asUInt})!, [1, 2, 3])
        XCTAssertEqual((m?.root?["an"]?.asVector?.makeIterator().flatMap{$0.asUInt})!, [2, 3, 4])
        XCTAssertEqual((m?.root?["ao"]?.asVector?.makeIterator().flatMap{$0.asUInt})!, [1, 2, 3, 4])
        XCTAssertEqual((m?.root?["ap"]?.asVector?.makeIterator().flatMap{$0.asUInt})!, [2, 3, 4, 5])
        XCTAssertEqual((m?.root?["aq"]?.asVector?.makeIterator().flatMap{$0.asDouble})!, [1.1, 2.1])
        XCTAssertEqual((m?.root?["ar"]?.asVector?.makeIterator().flatMap{$0.asDouble})!, [2.1, 3.1])
        XCTAssertEqual((m?.root?["as"]?.asVector?.makeIterator().flatMap{$0.asDouble})!, [1.1, 2.1, 3.1])
        XCTAssertEqual((m?.root?["at"]?.asVector?.makeIterator().flatMap{$0.asDouble})!, [2.1, 3.1, 4.1])
        XCTAssertEqual((m?.root?["au"]?.asVector?.makeIterator().flatMap{$0.asDouble})!, [1.1, 2.1, 3.1, 4.1])
        XCTAssertEqual((m?.root?["av"]?.asVector?.makeIterator().flatMap{$0.asDouble})!, [2.1, 3.1, 4.1, 5.1])
        XCTAssertEqual((m?.root?["aw"]?.asVector?.makeIterator().flatMap{$0.asInt})!, [1, 2])
        XCTAssertEqual((m?.root?["ax"]?.asVector?.makeIterator().flatMap{$0.asInt})!, [2, 3])
        XCTAssertEqual((m?.root?["ay"]?.asVector?.makeIterator().flatMap{$0.asInt64})!, [3, 4])
        XCTAssertEqual((m?.root?["az"]?.asVector?.makeIterator().flatMap{$0.asInt64})!, [5, 6])
        XCTAssertEqual((m?.root?["ba"]?.asVector?.makeIterator().flatMap{$0.asUInt})!, [4, 4])
        XCTAssertEqual((m?.root?["bb"]?.asVector?.makeIterator().flatMap{$0.asUInt})!, [5, 5])
        XCTAssertEqual((m?.root?["bc"]?.asVector?.makeIterator().flatMap{$0.asUInt64})!, [5, 4])
        XCTAssertEqual((m?.root?["bd"]?.asVector?.makeIterator().flatMap{$0.asUInt64})!, [6, 5])
        XCTAssertEqual((m?.root?["be"]?.asVector?.makeIterator().flatMap{$0.asDouble})!, [3.5, 4.2])
        XCTAssertEqual((m?.root?["bf"]?.asVector?.makeIterator().flatMap{$0.asDouble})!, [6.2, -5.8])
        XCTAssertEqual((m?.root?["bg"]?.asVector?.makeIterator().flatMap{$0.asBool})!, [true, false, true])
        XCTAssertEqual((m?.root?["bh"]?.asVector?.makeIterator().flatMap{$0.asBool})!, [false, false, true])
        XCTAssertEqual((m?.root?["bi"]?.asVector?.makeIterator().flatMap{$0.asString})!, ["a", "b"])
        XCTAssertEqual((m?.root?["bj"]?.asVector?.makeIterator().flatMap{$0.asString})!, ["c", "d"])
        XCTAssertEqual((m?.root?["bk"]?.asVector?.makeIterator().flatMap{$0.asString})!, ["e", "f"])
        XCTAssertEqual((m?.root?["bl"]?.asVector?.makeIterator().flatMap{$0.asString})!, ["g", "h"])
        XCTAssertEqual((m?.root?["bm"]?.asVector?.makeIterator().flatMap{$0.asInt})!, [1, 3, 4])
        XCTAssertEqual((m?.root?["bn"]?.asVector?.makeIterator().flatMap{$0.asInt})!, [1, 3, 5])
